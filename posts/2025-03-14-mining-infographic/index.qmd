...
## Visual decision
Because of my intended audience, I made some aesthetic choices that made the infographic less informal. Despite this, to add some levity and draw the reader in, I decided to open up with a joke. I wanted the theme, colors, and text to all be in the natural domain. That is, I thought green and darker colors would be applicable to the themes. I wanted to make sure not to overwhelm the observer, even though there was a lot of information to communicate. While there were not a lot of people involved in my data and visualization, I was interested in applying a lense of care to the project. It centers around the themes of the smallest beings getting left behind. Large industrialization projects do not center the needs of these little critters. While this is not directly a DEI lens to this project, it is a lens of inclusivity as it relates to animals. I haven't focused that much on ecology in my studies at Bren, and though it is not my main interest, this has been a great dive into the reality of life for those much smaller than I. 
